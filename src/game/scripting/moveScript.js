...
export const MOVE_OPCODE = [
    ...
    { opcode: 0x02, command: "BODY", callback: msBODY, offset: 0 },
    { opcode: 0x03, command: "ANIM", callback: msANIM, offset: 0 },
    { opcode: 0x04, command: "GOTO_POINT", callback: msGOTO_POINT, offset: 0 },
    { opcode: 0x05, command: "WAIT_ANIM", callback: msWAIT_ANIM, offset: 0 },
    // unused
    { opcode: 0x07, command: "ANGLE", callback: msANGLE, offset: 0 },
    { opcode: 0x08, command: "POS_POINT", callback: msPOS_POINT, offset: 0 },
    { opcode: 0x09, command: "LABEL", callback: msLABEL, offset: 0 },
    { opcode: 0x0A, command: "GOTO", callback: msGOTO, offset: 0 },
    { opcode: 0x0B, command: "STOP", callback: msSTOP, offset: 0 },
    { opcode: 0x0C, command: "GOTO_SYM_POINT", callback: msGOTO_SYM_POINT, offset: 0 },
    { opcode: 0x0D, command: "WAIT_NUM_ANIM", callback: msWAIT_NUM_ANIM, offset: 0 },
    { opcode: 0x0E, command: "SAMPLE", callback: msSAMPLE, offset: 0 },
    { opcode: 0x0F, command: "GOTO_POINT_3D", callback: msGOTO_POINT_3D, offset: 0 },
    { opcode: 0x10, command: "SPEED", callback: msSPEED, offset: 0 },
    { opcode: 0x11, command: "BACKGROUND", callback: msBACKGROUND, offset: 0 },
    { opcode: 0x12, command: "WAIT_NUM_SECOND", callback: msWAIT_NUM_SECOND, offset: 0 },
    { opcode: 0x13, command: "NO_BODY", callback: msNO_BODY, offset: 0 },
    { opcode: 0x14, command: "BETA", callback: msBETA, offset: 0 },
    { opcode: 0x15, command: "OPEN_LEFT", callback: msOPEN_LEFT, offset: 0 },
    { opcode: 0x16, command: "OPEN_RIGHT", callback: msOPEN_RIGHT, offset: 0 },
    { opcode: 0x17, command: "OPEN_UP", callback: msOPEN_UP, offset: 0 },
    { opcode: 0x18, command: "OPEN_DOWN", callback: msOPEN_DOWN, offset: 0 },
    { opcode: 0x19, command: "CLOSE", callback: msCLOSE, offset: 0 },
    { opcode: 0x1A, command: "WAIT_DOOR", callback: msWAIT_DOOR, offset: 0 },
    { opcode: 0x1B, command: "SAMPLE_RND", callback: msSAMPLE_RND, offset: 0 },
    { opcode: 0x1C, command: "SAMPLE_ALWAYS", callback: msSAMPLE_ALWAYS, offset: 0 },
    { opcode: 0x1D, command: "SAMPLE_STOP", callback: msSAMPLE_STOP, offset: 0 },
    { opcode: 0x1E, command: "PLAY_ACF", callback: msPLAY_ACF, offset: 0 },
    { opcode: 0x1F, command: "REPEAT_SAMPLE", callback: msREPEAT_SAMPLE, offset: 0 },
    { opcode: 0x20, command: "SIMPLE_SAMPLE", callback: msSIMPLE_SAMPLE, offset: 0 },
    { opcode: 0x21, command: "FACE_HERO", callback: msFACE_HERO, offset: 0 },
    { opcode: 0x22, command: "ANGLE_RND", callback: msANGLE_RND, offset: 0 },
    { opcode: 0x23, command: "REPLACE", callback: msREPLACE, offset: 0 },
    { opcode: 0x24, command: "WAIT_NUM_DECIMAL", callback: msWAIT_NUM_DECIMAL, offset: 0 },
    // unused
    { opcode: 0x26, command: "SPRITE", callback: msSPRITE, offset: 0 },
    { opcode: 0x27, command: "WAIT_NUM_SECOND_RND", callback: msWAIT_NUM_SECOND_RND, offset: 0 },
    // unused
    { opcode: 0x29, command: "SET_FRAME", callback: msSET_FRAME, offset: 0 },
    { opcode: 0x2A, command: "SET_FRAME_3DS", callback: msSET_FRAME_3DS, offset: 0 },
    { opcode: 0x2B, command: "SET_START_3DS", callback: msSET_START_3DS, offset: 0 },
    { opcode: 0x2C, command: "SET_END_3DS", callback: msSET_END_3DS, offset: 0 },
    { opcode: 0x2D, command: "START_ANIM_3DS", callback: msSTART_ANIM_3DS, offset: 0 },
    ...
    { opcode: 0x31, command: "WAIT_NUM_DECIMAL_RND", callback: msWAIT_NUM_DECIMAL_RND, offset: 0 },
    { opcode: 0x32, command: "INTERVAL", callback: msINTERVAL, offset: 0 },
    { opcode: 0x33, command: "FREQUENCY", callback: msFREQUENCY, offset: 0 },
    { opcode: 0x34, command: "VOLUME", callback: msVOLUME, offset: 0 }
];
