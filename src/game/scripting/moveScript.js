...
export const MOVE_OPCODE = [
    ...
    { opcode: 0x12, command: "WAIT_NUM_SECOND", callback: msWAIT_NUM_SECOND, offset: 1 },
    ...
    { opcode: 0x24, command: "WAIT_NUM_DECIMAL", callback: msWAIT_NUM_DECIMAL, offset: 1 },
    // unused
    { opcode: 0x26, command: "SPRITE", callback: msSPRITE, offset: 0 },
    { opcode: 0x27, command: "WAIT_NUM_SECOND_RND", callback: msWAIT_NUM_SECOND_RND, offset: 2 },
    // unused
    ...
    { opcode: 0x31, command: "WAIT_NUM_DECIMAL_RND", callback: msWAIT_NUM_DECIMAL_RND, offset: 1 },
