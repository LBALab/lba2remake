...
export const LifeOpcode = [
    ...
    { opcode: 0x02, command: "SNIF", callback: lo.SNIF, offset: 0, condition: true, operator: true, indent: Indent.ADD},
    { opcode: 0x03, command: "OFFSET", callback: lo.OFFSET, offset: 0, indent: Indent.KEEP},
    { opcode: 0x04, command: "NEVERIF", callback: lo.NEVERIF, offset: 0, condition: true, operator: true, indent: Indent.ADD},
    ...
    { opcode: 0x0C, command: "IF", callback: lo.IF, offset: 0, condition: true, operator: true, indent: Indent.ADD},
    { opcode: 0x0D, command: "SWIF", callback: lo.SWIF, offset: 0, condition: true, operator: true, indent: Indent.ADD},
    { opcode: 0x0E, command: "ONEIF", callback: lo.ONEIF, offset: 0, condition: true, operator: true, indent: Indent.ADD},
    ...
    { opcode: 0x37, command: "OR_IF", callback: lo.OR_IF, offset: 0, condition: true, operator: true, indent: Indent.KEEP},
