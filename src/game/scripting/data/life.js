...
export const LifeOpcode = [
    ...
    { opcode: 0x01, command: "NOP", callback: lo.NOP, offset: 0, indent: Indent.KEEP },
    ...
    { opcode: 0x0C, command: "IF", callback: lo.IF, offset: 0, args: ['_Uint16:offset'], condition: true, operator: true, indent: Indent.ADD},
    ...
    { opcode: 0x72, command: "OR_CASE", callback: lo.OR_CASE, offset: 0, argsFirst: true, args: ['_Uint16'], operator: true, indent: Indent.KEEP},
    { opcode: 0x73, command: "CASE", callback: lo.CASE, offset: 0, argsFirst: true, args: ['_Uint16'], operator: true, indent: Indent.ADD},
    { opcode: 0x74, command: "DEFAULT", callback: lo.DEFAULT, offset: 0, indent: Indent.ADD},
    { opcode: 0x75, command: "BREAK", callback: lo.BREAK, offset: 0, args: ['_Uint16'], indent: Indent.SUB},
    { opcode: 0x76, command: "END_SWITCH", callback: lo.END_SWITCH, offset: 0, indent: Indent.SUB},
    { opcode: 0x77, command: "SET_HIT_ZONE", callback: ls.SET_HIT_ZONE, offset: 2, args: ['Uint8', 'Uint8'], indent: Indent.KEEP},
    ...
    { opcode: 0x7E, command: "REPEAT_SAMPLE", callback: ls.REPEAT_SAMPLE, offset: 3, args: ['Uint16', 'Uint8'], indent: Indent.KEEP},
