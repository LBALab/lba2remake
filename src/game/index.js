    ...
    return {
        ...
        preload: function(callback: Function) {
            ...
            async.auto({
                ...
                voxgame: preloadFileAsync(`data/VOX/${_state.config.language.acronym}_GAM_AAC.VOX`),
                vox000: preloadFileAsync(`data/VOX/${_state.config.language.acronym}_000_AAC.VOX`),
