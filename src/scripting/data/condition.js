...
export const ConditionOpcode = [
    { opcode: 0x00, command: "COL", callback: lc.COL, operand: 'Uint8' },
    { opcode: 0x01, command: "COL_OBJ", callback: lc.COL_OBJ, param: 'Uint8', operand: 'Uint8' },
    { opcode: 0x02, command: "DISTANCE", callback: lc.DISTANCE, param: 'Uint8', operand: 'Uint16' },
    ...
    { opcode: 0x08, command: "ANIM_OBJ", callback: lc.ANIM_OBJ, param: 'Uint8', operand: 'Uint16' },
    ...
    { opcode: 0x0B, command: "VAR_CUBE", callback: lc.VAR_CUBE, param: 'Uint8', operand: 'Uint8' },
    ...
    { opcode: 0x0F, command: "VAR_GAME", callback: lc.VAR_GAME, param: 'Uint8', operand: 'Uint16' },
    { opcode: 0x10, command: "LIFE_POINT", callback: lc.LIFE_POINT, operand: 'Uint16' },
    { opcode: 0x11, command: "LIFE_POINT_OBJ", callback: lc.LIFE_POINT_OBJ, param: 'Uint8', operand: 'Uint16' },
    ...
    { opcode: 0x16, command: "DISTANCE_3D", callback: lc.DISTANCE_3D, param: 'Uint8', operand: 'Uint16' },
